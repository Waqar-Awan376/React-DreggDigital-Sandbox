...
const NavigationController =  ({ history }) => {
  const { muteBackground, setMuteBackground } = AudioService.useContainer()
  ...
  const handleMute = () => {
    setMuteBackground(!muteBackground)
  }
  const hideAll = () => {
    setShowBack(false)
    setShowHint(false)
    ...
    <Wrapper>
      ...
      <IconButton className='mute-button' id='muteBtn' onClick={() => handleMute}>
        ...
        <span aria-hidden="true">
            ...
            <img src="images/icons/unmute.png" alt="unmute" style={{display:"none"}}/>
        </span>
      </IconButton>
